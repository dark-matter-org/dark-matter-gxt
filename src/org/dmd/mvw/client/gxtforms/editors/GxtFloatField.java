...
//public class GxtFloatField extends NumberField implements DmcPresentationIF {
public class GxtFloatField implements DmcPresentationIF {
...
//	DmcObject					DMO;
//
//	public GxtFloatField(){
//		attrIndex = -1;
//		setPropertyEditorType(Float.class);
//		
...
//									READY();
//									System.out.println("GxtFloatField: setMVnth " + attrIndex + " " + getValue() + " READY");
//								} catch (DmcValueException e) {
...
//							else{
//								NOTREADY();
//								System.out.println("GxtFloatField: invalid value: " + attrIndex + " " + getValue() + " NOT READY");
//							}
//						}
//					}
//					else{
...
//	@Override
//	public void setAdapter(DmcAdapterIF adapter) {
//		if (!adapter.getAttributeInfo().type.equals("Float"))
//			throw(new IllegalStateException("The GxtFloatField editor is only applicable to Float values!"));
//
//		this.adapter 	= adapter;
//		attribute 		= (DmcTypeFloat) adapter;
//		setDisplayValue();
//	}
//	
...
//		
//		if (!rendered){
//			if (getValidator().validate(this, getValue().toString()) == null){
